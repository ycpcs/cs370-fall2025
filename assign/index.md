...
All written portions **MUST BE SELF-GRADED** (or no credit will be given for the written portion) and should be submitted to Canvas **NO LATER THAN TWO DAYS after the due date**. 

All programming portions (except the final project) should be uploaded to [Marmoset](https://cs.ycp.edu/marmoset/)
