...
Download [CS370\_Assign03\_Fa25.zip](src/CS370_Assign03_Fa25.zip), saving it into the **CS370\_Fa25** directory.

Double-click on **CS370\_Assign03\_Fa25.zip** and extract the contents of the archive into a subdirectory called **CS370\_Assign03\_Fa25**

Open CLion, select **CS370\_Fa25** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Assign03\_Fa25** subdirectory). Uncomment the line

```cpp
	add_subdirectory("CS370_Assign03_Fa25" "CS370_Assign03_Fa25/bin")
```
...
**Note:** For Mac's running Sequoia, you will need to follow these [instructions](https://discussions.apple.com/thread/255759797?sortBy=rank) to be able to run the demo.
...
<pre>
$ <b>cd CS370_Assign03_Fa25</b>
CS370_Fa25/CS370_Assign03_Fa25
$ <b>make submit_ms1</b>
</pre>
