...
Download [CS370\_Assign02\_Fa25.zip](src/CS370_Assign02_Fa25.zip), saving it into the **CS370\_Fa25** directory.

Double-click on **CS370\_Assign02\_Fa25.zip** and extract the contents of the archive into a subdirectory called **CS370\_Assign02\_Fa25**

Open CLion, select **CS370\_Fa25** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Assign02\_Fa25** subdirectory). Uncomment the line

```cpp
	add_subdirectory("CS370_Assign02_Fa25" "CS370_Assign02_Fa25/bin")
```
