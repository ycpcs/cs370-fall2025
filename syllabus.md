...
**Section 101 (2:00pm):** Dr. David Babcock <dbabcock@ycp.edu>
...
Class times:
 ...
 -------- | --------  |  ----------- | ------- | ----------
101       | Tue/Thur  | 2:00-3:15PM  | KEC 119 | Thur, Dec 11 - 12:45pm
...
Please check the [course web page](<http://ycpcs.github.io/cs370-fall2025/>), regularly for important announcements.
...
The written portion of assignments will be submitted as .pdf's via Canvas. Programming portions for assignments will be submitted using the [Marmoset](https://cs.ycp.edu/marmoset) server. You will receive an email containing the username and password you should use for this server.
