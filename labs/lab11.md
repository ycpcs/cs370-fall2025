...
At this point you should see a bouncing sphere and torus rolling around a translucent cone. The **b** key will toggle the sphere bouncing, and the **r** key will toggle the torus rolling.
